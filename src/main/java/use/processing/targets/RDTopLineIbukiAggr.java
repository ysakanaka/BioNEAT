...
public class RDTopLineIbukiAggr {
	...
	//  boolean [][] target=RDPatternFitnessResultIbuki.getSmileyFace();
	 ...
	 RDPatternFitnessResultIbuki.weightExponential = 0.11;
	 RDConstants.matchPenalty=-RDPatternFitnessResultIbuki.weightExponential;
	  ...
	  RDConstants.targetName = "IbukiTopCenterAggr";
	  ...
	  for(int i=0;i<fullMap.length; i++){
	   ...
	   RDConstants.defaultRandomFitness = 0.0;//RDPatternFitnessResultIbuki.distanceBlurExponentialOfRandomBeads(target);
